...
struct PaymentFormView: View {
    ...
    private func save() {
        let newPayment = PaymentActivity(date: paymentFormViewModel.date, name: paymentFormViewModel.name, amount: Double(paymentFormViewModel.amount) ?? 0.0, type: paymentFormViewModel.type)
...
struct ValidationErrorText: View {
    ...
    var iconColor = Color(red: 251/255, green: 129/255, blue: 128/255)
