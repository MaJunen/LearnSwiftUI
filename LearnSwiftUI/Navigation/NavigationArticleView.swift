...
struct NavigationArticleView: View {
    var body: some View {
        NavigationStack {
            List(articles) { article in
                ZStack {
                    ...
                    NavigationLink(destination: NavigationArticleDetailView(article: article)) {
                        EmptyView()
                    }
                    .opacity(0)
                }
...
struct NavigationArticleRow: View {
...
struct NavigationArticle: Identifiable {
    var id = UUID()
    var title: String
    var author: String
    var rating: Int
